...
var phoneBook = [];
var book = [];
//DONE! 1. Проверка валится на первичном добавлении номера, нужно разделять номера запятой и пробелом
// 2. Переделать функцию добавления номера на такую чтобы номера разделяло пробелом
//DONE 3. Функция remove_phone должна возвразать bool !!!
/**
